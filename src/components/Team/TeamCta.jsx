        ...
        <section className="flex flex-col py-20 px-20 gap-15 mx-auto items-center text-center justify-center">
          <article className="font-montserrat flex flex-col items-center gap-8 ">
            <h2 className="font-bold text-[40px] leading-13 text-text-color">
              {teamSection.teamCta.title}
            </h2>
            <p className="font-normal text-sm leading-5 text-second-text-color">
              {teamSection.teamCta.paragraph}
            </p>
            <button className="text-sm leading-6 text-white py-4 px-10 rounded-md gap-2.5 bg-primary-color">
              {teamSection.teamCta.buttonText}
            </button>
          </article>
          <article>
