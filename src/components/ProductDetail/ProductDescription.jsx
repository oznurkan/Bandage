            ...
            <div className="flex flex-col gap-12 pt-10 xl:flex-row items-start animate-fadeIn">
              ...
              <div className="flex flex-col gap-6 xl:flex-1">
                ...
                <p className="font-normal text-sm leading-6 text-second-text-color">
                  ...
                  <br />
                  <br />
                  Modern kesimi ile günlük kullanımda şıklığınızı tamamlayan bu
                  özel parça, kaliteli dokusuyla uzun ömürlü bir kullanım vaat
                  ediyor.
                </p>
              </div>
              <div className="flex flex-col gap-6 xl:flex-1">
            ...
            <div className="pt-10 animate-fadeIn grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="p-6 bg-thin-white rounded-lg">
                ...
                <ul className="text-second-text-color space-y-2 text-sm">
                  <li>
                    <strong>Ağırlık:</strong> 450gr
                  </li>
                  <li>
                    <strong>Boyutlar:</strong> Standart Fit
                  </li>
                  <li>
                    <strong>Renk:</strong> Çoklu Renk Seçeneği
                  </li>
                </ul>
              </div>
              <div className="p-6 bg-thin-white rounded-lg">
                ...
                <p className="text-second-text-color text-sm">
                  Siparişleriniz 24 saat içinde kargoya verilir. 14 gün içinde
                  ücretsiz iade hakkınız bulunmaktadır.
                </p>
              </div>
            </div>
          )}
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <p className="text-sm italic">
                    "Harika bir ürün, kumaş kalitesi beklediğimden çok daha iyi
                    çıktı!"
                  </p>
